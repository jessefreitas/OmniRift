// scripts/run-first-value-tests.mjs
//
// Runner dos testes PUROS do M1 first-value (apps/desktop não tem vitest).
// Uso: node scripts/run-first-value-tests.mjs
...
const result = await build({
  entryPoints: [resolve(root, "src/lib/first-value.test.ts")],
  bundle: true,
  write: false,
  format: "esm",
  platform: "node",
...
const out = resolve(here, ".first-value-test.bundle.mjs");
