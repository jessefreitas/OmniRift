...
const suites = ["canvas-fluency.test.ts", "canvas-score.test.ts", "event-broker.test.ts", "drag-buffer.test.ts", "floor-mount-policy.test.ts", "bench-flags.test.ts", "bench-load.test.ts", "canvas-bench.test.ts"];
